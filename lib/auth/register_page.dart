...
class _RegisterPageState extends State<RegisterPage> {
  ...
  final Color _hospitalColor = const Color(0xFF0077B6); // Biru Medis yang Tenang
      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: ColorScheme.light(primary: _hospitalColor),
          ),
          child: child!,
        );
      },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Pendaftaran Pasien", style: TextStyle(fontWeight: FontWeight.bold)),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: Text("Pastikan NIK sesuai KTP dan Nomor HP aktif.", style: TextStyle(color: _hospitalColor, fontSize: 12, fontWeight: FontWeight.w500))),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    hint: Row(children: [Icon(Icons.wc, color: _hospitalColor, size: 20), const SizedBox(width: 10), const Text("Pilih Jenis Kelamin")]),
                    isExpanded: true,
              ...
              // --- GROUP 3: IDENTITAS ---
              _buildSectionTitle("Rekam Medis & Identitas", Icons.assignment_ind_outlined),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.vpn_key_outlined, color: _hospitalColor),
                  ...
                  focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide: BorderSide(color: _hospitalColor, width: 2)),
                ),
              ),
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      validator: validator ?? (val) => (isRequired && (val == null || val.isEmpty)) ? "$label wajib diisi" : null,
      decoration: InputDecoration(
        labelText: label,
